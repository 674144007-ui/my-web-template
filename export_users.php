...
$sql = "SELECT u.id, u.username, u.display_name, r.role_key AS role, u.created_at, c.class_name, c.level, c.room 
        FROM users u 
...
$sql .= " ORDER BY r.role_key ASC, c.level ASC, c.room ASC, u.display_name ASC";
